...
const Banner = () => {
    return (
        <>
            <section className='BANNER bg-[#F2F0F1] overflow-hidden flex justify-center'>
                <div className='flex lg:flex-row flex-col justify-between w-full max-w-[1920px] defaultPadding'>
            ...
            <section className='bg-primary flex justify-center'>
                <div className='w-full max-w-[1920px]'>
                    <div className="flex flex-wrap lg:justify-between justify-center items-center defaultPadding py-10 gap-6">
