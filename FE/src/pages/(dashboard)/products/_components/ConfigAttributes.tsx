                                ...
                                <div className="flex flex-col max-w-[860px] overflow-hidden">
                                    ...
                                    >
                                        {attri.terms && attri.terms.length > 0
                                            ?
                                            (() => {
                                                const filterTerm = attri.terms.filter(
                                                    (terms: any) => attri.value && !attri.value.some((val: any) => val._id === terms._id)
                                                );
                                                ...
                                                return filterTerm.map((term: any) => (
                                                    <div
