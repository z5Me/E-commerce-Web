                    ...
                    <div className='lg:flex grid grid-cols-2 lg:gap-12 gap-6 justify-between'>
                        <div className='flex flex-col justify-between lg:gap-y-[35px] gap-y-5 col-span-full'>
                            <div className='flex flex-col lg:gap-y-[25px] gap-y-[14px]'>
                                ...
                                <p className='text-sm font-MJSatoshi text-primary/60 lg:max-w-[248px] w-full'>
                        ...
                        <div className='flex flex-col lg:gap-y-[25px] gap-y-4'>
                            <p className='uppercase font-MJSatoshi font-medium lg:text-base text-sm tracking-[3px]'>company</p>
                        ...
                        <div className='flex flex-col lg:gap-y-[25px] gap-y-4'>
                            <p className='uppercase font-MJSatoshi font-medium lg:text-base text-sm tracking-[3px]'>help</p>
                            <div className='flex flex-col justify-between lg:gap-y-0 gap-y-4 lg:text-base text-sm text-primary/60 h-full *:hover:underline *:cursor-pointer'>
                        ...
                        <div className='flex flex-col lg:gap-y-[25px] gap-y-4'>
                            <p className='uppercase font-MJSatoshi font-medium lg:text-base text-sm tracking-[3px]'>FAQ</p>
                            <div className='flex flex-col justify-between lg:gap-y-0 gap-y-4 lg:text-base text-sm text-primary/60 h-full *:hover:underline *:cursor-pointer'>
                                <p>Account</p>
                        ...
                        <div className='flex flex-col lg:gap-y-[25px] gap-y-4'>
                            <p className='uppercase font-MJSatoshi font-medium lg:text-base text-sm tracking-[3px]'>resources</p>
                            <div className='flex flex-col justify-between lg:gap-y-0 gap-y-4 lg:text-base text-sm text-primary/60 h-full *:hover:underline *:cursor-pointer'>
                                <p>Free eBooks</p>
